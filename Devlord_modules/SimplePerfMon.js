...
var Memory = {
    ...
    "Free": function (Unit) {
        ...
        this.UsageHistoryGB.push(round(Result / 1000000000, 2));
        if (this.UsageHistory.length > MaxHistoryLength) {
            this.UsageHistory = this.UsageHistory.slice(1, this.UsageHistory.length)
        }
        if (this.UsageHistoryGB.length > MaxHistoryLength) {
            this.UsageHistoryGB = this.UsageHistoryGB.slice(1, this.UsageHistoryGB.length)
        }
